...
class ContainerViewController: UIViewController, CenterViewControllerDelegate, UIGestureRecognizerDelegate {
    ...
    func addRightPanelViewController() {
        if (rightViewController == nil) {
            ...
            rightViewController?.containerViewController = self
...
private extension UIStoryboard {
    ...
    class func leftViewController() -> LeftSideTableViewController? {
        var leftViewController =  mainStoryboard().instantiateViewControllerWithIdentifier("LeftViewController") as? LeftSideTableViewController
        return leftViewController
    }
    
    class func rightViewController() -> RightSideTableViewController? {
        return mainStoryboard().instantiateViewControllerWithIdentifier("RightViewController") as? RightSideTableViewController
    }
